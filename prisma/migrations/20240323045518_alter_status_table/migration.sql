...
INSERT INTO "new_cases" ("city", "clientId", "company", "createdAt", "description", "documents", "id", "lawyerId", "ocurrenceDate", "state", "statusId", "typeId", "updatedAt") SELECT "city", "clientId", "company", "createdAt", "description", "documents", "id", "lawyerId", "ocurrenceDate", "state", "statusId", "typeId", "updatedAt" FROM "cases";
DROP TABLE "cases";
